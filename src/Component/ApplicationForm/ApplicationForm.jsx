...
const ApplicationForm = () => {
  ...
  return (
    <div className="applicationform-container">
      ...
      {/* Header */}
      <div className="applicationform-header" style={{ backgroundImage: `url(${bannerBg})` }}> 
        ...
        <div className="applicationform-form-container">
          ...
          <div className="applicationform-form-section">
            <div className="applicationform-section-header">
              <h2 className="applicationform-section-title">Personal information</h2>
              <button className="applicationform-clear-btn" onClick={handleClearForm}>
                Clear
              </button>
            </div>
            ...
            <div className="applicationform-form-row">
              <div className="applicationform-form-group">
                ...
                <input 
                  type="text" 
                  name="firstName"
                  className={`applicationform-form-input ${errors.firstName ? 'applicationform-input-error' : ''}`}
              ...
              <div className="applicationform-form-group">
                ...
                <input 
                  type="text" 
                  name="lastName"
                  className={`applicationform-form-input ${errors.lastName ? 'applicationform-input-error' : ''}`}
            ...
            <div className="applicationform-form-group">
              ...
              <input 
                type="email" 
                name="email"
                className={`applicationform-form-input ${errors.email ? 'applicationform-input-error' : ''}`}
            ...
            <div className="applicationform-form-group">
              ...
              <div className="applicationform-phone-input-group">
                ...
                <input 
                  type="tel" 
                  name="phone"
                  className={`applicationform-form-input applicationform-phone-number ${errors.phone ? 'applicationform-input-error' : ''}`}
            ...
            <div className="applicationform-form-group">
              ...
              <div 
                className={`applicationform-file-upload-area ${errors.resume ? 'applicationform-upload-error' : ''} ${formData.resume ? 'applicationform-upload-success' : ''} ${uploading ? 'applicationform-uploading' : ''}`}
                ...
                {uploading ? (
                  ...
                  <div className="applicationform-upload-success-content">
                    ...
                    <div className="applicationform-upload-text">
                      ...
                      <br />
                      <span className="applicationform-upload-subtext">File uploaded successfully</span>
                    </div>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="applicationform-upload-text">
                      <span className="applicationform-upload-link">Upload a file</span> or drag and drop here
                    </div>
                  </>
                )}
              </div>
            ...
            <div className="applicationform-form-group">
              <label className="applicationform-form-label">
                Cover Letter <span className="applicationform-optional">(optional)</span>
              </label>
              <textarea 
            ...
            <div className="applicationform-form-group">
              <label className="applicationform-form-label">
                Expected Salary <span className="applicationform-optional">(optional)</span>
              </label>
              <input 
                type="text" 
          ...
          <div className="applicationform-submit-section">
            <button className="applicationform-submit-btn" onClick={handleSubmit}>
              Submit Application
            </button>
          </div>
        </div>
