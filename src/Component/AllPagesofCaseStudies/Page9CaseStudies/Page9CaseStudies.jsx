             ...
             <div className="challenges-section">
              <div className="challenges-1">
                <div className='challenge-content'>
                  ...
                  <p><span> <strong>Revenue Struggles</strong> – Monthly revenue was limited to $374,665 with 15,000 units sold, far below the brand's potential.</span></p>
                  <p><span> <strong>Inventory Mismanagement</strong> – Stock reserves did not align with sales pace, leading to frequent stockouts and long periods of unavailability, disrupting sales momentum.</span></p>
                  <p><span> <strong>Low CTR & CVR</strong> – The product's CTR was only 0.25%, and conversion rates remained low, indicating ineffective listings and ad engagement.</span></p>
                  <p><span> <strong>Inefficient PPC Campaigns</strong> – The existing ad campaigns were poorly structured, with too many keywords, irregular bid adjustments, and inefficient budget allocation, leading to wasted ad spend and poor performance.</span></p>
                  <p><span> <strong>Poor Organic Ranking</strong> – The product had an average ranking position of 33, making it difficult to gain visibility in search results and compete with top-performing listings.</span></p>
                </div>
        ...
        {/*Strategies & Solutions  */}
              ...
              <img src={strategies} alt="Logo" />        
                ...
                <div className='challenge-content-2'>
                  ...
                  <div>
    <ul>
        <li><p><strong>Inventory Stability</strong> – Developed a demand-based restocking plan to prevent stockouts and maintain a steady sales pace, ensuring consistent availability.</p></li>
    </ul>
    <ul>
        <li><p><strong>Listing Optimization</strong> – Enhanced titles, bullet points, images, and A+ Content with keyword-rich descriptions and persuasive elements to improve engagement and conversions.</p></li>
    </ul>
    <ul>
        <li><p><strong>PPC Revamp</strong> – Restructured ad campaigns by:</p>
        <ul>
        <p>• Pausing non-performing keywords and focusing on high-converting search terms.</p>
        <p>• Implementing a bid optimization strategy to control ad spend and improve ROI.</p>
        <p>• Reallocating budgets to the best-performing campaigns for maximum profitability.</p>
        </ul>
        </li>
    </ul>
    <ul>
        <li><p><strong>Conversion Rate Optimization (CRO)</strong> – Improved product positioning, pricing strategy, and promotions to make the offer more attractive to potential buyers.
        </p></li>
    </ul>
    <ul>
        <li><p><strong>Ranking Improvement Strategy</strong> – Focused on organic ranking growth by improving PPC structure, refining keyword indexing, and directing external traffic to boost search visibility.</p></li>
    </ul>
</div>
                </div>
